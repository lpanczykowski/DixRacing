...
namespace DixRacing.DataAccess.Migrations
{
    ...
    [Migration("20220731165341_Add_GameId_To_Tracks")]
    partial class Add_GameId_To_Tracks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DixRacing.Domain.Tracks.Track", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DixRacing.Domain.Rounds.Round", b =>
                {
                    ...
                    b.HasOne("DixRacing.Domain.Tracks.Track", "Track")
                        .WithMany()
            ...
            modelBuilder.Entity("DixRacing.Domain.Tracks.Track", b =>
                {
                    b.HasOne("DixRacing.Domain.Utility.Game", "Game")
                        .WithMany()
