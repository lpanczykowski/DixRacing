...
{
    public partial class raceEntityChanges : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PracticeLength = table.Column<DateTime>(type: "TEXT", nullable: false),
                    QualiDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    QualiLength = table.Column<DateTime>(type: "TEXT", nullable: false),
                    RaceDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    RaceLength = table.Column<DateTime>(type: "TEXT", nullable: false),
